...
$(document).ready(function() {
    ...
    $("#earningAndExpenseYear").change(function(){
        ...
        if(year){
            $("#yearAccountLoading").html("<i class='"+spinnerClass+"'></i> Cargando...");
...
$("td").each(function(){
        if($(this).html().indexOf("Monday") > -1){
          $(this).html().replace("Monday","Lunces");
...
function getEarnings(year){
    ...
    $.ajax({
        ...
        document.getElementById('earningsTitle').innerHTML = "Ganancias (" + response.earningsYear +")";
