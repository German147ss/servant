...
$(document).ready(function(){
	...
	var local = $("#local").val();
        ...
        if(!firstName || !lastName || !email || !role || !mobile1 || !passwordOrig || !passwordDup || !local){
	    ...
	    !local ? changeInnerHTML('local', "required") : "";
        ...
        $.ajax({
            ...
            data: {firstName:firstName, lastName:lastName, email:email, role:role, local:local, mobile1:mobile1, mobile2:mobile2,
