        ...
        <nav class="navbar navbar-default hidden-print">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?=base_url()?>" style="margin-top:-10px">
                        <img src="<?=base_url()?>public/images/logo_white.png" alt="logo" class="img-responsive" width="45px"  style="
    height: 40px;">
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="nav navbar-nav navbar-left visible-xs">
                        ...
                        <li class="<?= $pageTitle == 'Services' ? 'active' : '' ?>">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a>
                                Total ganado hoy: <b>$<span id="totalEarnedToday"></span></b>
                            </a>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-menu-header text-center">
                                    <?php if($this->session->admin_name == ""): ?> <strong>Account</strong>
					                                 <?php  else:?>
						                                        <strong><?php echo $this->session->admin_name; ?></strong>
						                               <?php endif;?>
                                </li>
                                <li class="divider"></li>
                                  <li class="dropdown-menu-header text-center">
			 		                              <?php if($this->session->admin_local == ""): ?> <strong>Todos</strong>
					                                   <?php  else:?>
						                                    <p><?php echo $this->session->admin_local; ?></p>
						                                  <?php endif;?>
                                  </li>
                                <!---<li>
                                    <a href="#">
			...
			<li class="divider"></li>
                                <li class="dropdown-menu-header text-center"><li><a href="<?= site_url('logout') ?>"><i class="fa fa-sign-out"></i> Logout</a></li></li>
                            </ul>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header hidden-print">
                        ...
                        <h4 class="text-center">Recibo de la Venta</h4>
                    </div>
                        ...
                        <form name="logInModalForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 pull-right">
                                    <button id='loginModalSubmit' class="btn btn-primary">Ingresar</button>
                                </div>
                            </div>
                        </form>
                    </div>
