...
class Administrators extends CI_Controller{
    ...
    */
	...
	$this->form_validation->set_rules('local', 'Local', ['required'], ['required'=>"required"]);
        $this->form_validation->set_rules('mobile1', 'Phone number', ['required', 'trim', 'numeric', 'max_length[15]', 'min_length[7]', 'is_unique[admin.mobile1]'], 
        ...
        if($this->form_validation->run() !== FALSE){
            ...
            $inserted = $this->admin->add(set_value('firstName'), set_value('lastName'), set_value('email'), $hashedPassword, 
                set_value('role'), set_value('local'), set_value('mobile1'), set_value('mobile2'));
    ...
    */
    ...
    public function update(){
        ...
        $this->form_validation->set_rules('mobile1', 'Phone number', ['required', 'trim', 'numeric', 'max_length[15]', 
            'min_length[8]'], ['required'=>"required"]);
        $this->form_validation->set_rules('mobile2', 'Other number', ['trim', 'numeric', 'max_length[15]', 'min_length[8]']);
