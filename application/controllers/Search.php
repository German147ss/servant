...
class Search extends CI_Controller{
    ...
    */
    ...
    public function transSearch(){
        ...
        $json['employeeTable'] = $data['allTransactions'] ? $this->load->view('transactions/transtable', $data, TRUE) : "No match found";
    ...
    */
    ...
    public function employeesearch(){
        $data['allEmployees'] = $this->employee->employeesearch($this->value);
        $data['sn'] = 1;
        
        $json['allEmployees'] = $data['allEmployees'] ? $this->load->view('employees/employeeslist', $data, TRUE) : "No match found";
