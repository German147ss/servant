...
class Item extends CI_Model{
    ...
    ********************************************************************************************************************************
    */
    public function getAllLocal($orderBy, $orderFormat, $start=0, $limit='', $local){
        $this->db->limit($limit, $start);
        $this->db->order_by($orderBy, $orderFormat);
     ...
     * @return boolean
     */
    public function add($itemName, $itemQuantity, $itemCost, $itemPrice, $itemLocal, $itemDescription, $itemCode){
        $itemPoints = $itemPrice / 60;
        $data = ['name'=>$itemName, 'quantity'=>$itemQuantity, 'unitCost'=>$itemCost, 'unitPrice'=>$itemPrice, 'local'=>$itemLocal, 'description'=>$itemDescription, 'code'=>$itemCode, 'points'=>$itemPoints ];
    ...
    * @param type $itemPrice
    */
   public function edit($itemId, $itemName, $itemDesc, $itemCost, $itemPrice, $itemLocal){
       $itemPoints = $itemPrice / 60;
       $data = ['name'=>$itemName, 'unitCost'=>$itemCost, 'unitPrice'=>$itemPrice, 'description'=>$itemDesc, 'points'=>$itemPoints];
       $this->db->where('local', $itemLocal);
    ...
    */
     ...
     * return array | FALSE
     */
    public function getItemInfo($where_clause, $local, $fields_to_fetch){
    ...
    */
    ...
    public function getItemsCumCost(){
        $this->db->select("SUM(unitCost*quantity) as cumCost");

        $run_q = $this->db->get('items');

        return $run_q->num_rows() ? $run_q->row()->cumCost : FALSE;
    }
}
