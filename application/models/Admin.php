...
class Admin extends CI_Model{
    ...
    */
     ...
     * @return boolean
     */
    public function add($f_name, $l_name, $email, $password, $role, $local, $mobile1, $mobile2){
        $data = ['first_name'=>$f_name, 'last_name'=>$l_name, 'email'=>$email, 'password'=>$password, 'role'=>$role, 'local'=>$local,
    ...
    */
    ...
    public function get_admin_info($email){
        $this->db->select('id, first_name, last_name, role, local');
    ...
    */
    ...
    public function getAll($orderBy = "first_name", $orderFormat = "ASC", $start = 0, $limit = ""){
        $this->db->select('id, first_name, last_name, email, role, local, mobile1, mobile2, created_on, last_login, account_status, deleted');
        $this->db->where("id != ", $_SESSION['admin_id']);
 	$this->db->where("email != ", "servantelectronic@gmail.com" );
